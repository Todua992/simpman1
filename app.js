...
function preload() {
    ...
    pc_img = loadImage('images/pc_img.png');
    ...
    pacman_death_sound = loadSound('sounds/pacman_death.m4a');
    pacman_death_sound.setVolume(0.3);

    pacman_eatghost_sound = loadSound('sounds/ghost-die.mp3');
    pacman_eatghost_sound.setVolume(0.70);

    power_pellet_sound = loadSound('sounds/power_pellet.m4a');
    power_pellet_sound.setVolume(1.50);
